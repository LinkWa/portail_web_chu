...
CUSTOM_THEME_DATA = {}
THEME_FOOTER_TEXT = '&copy; Portail Web CHU'
...
FAIL_ON_MISSING_INTEGRATION_FORM_ELEMENT_PLUGINS = True
FAIL_ON_MISSING_INTEGRATION_FORM_HANDLER_PLUGINS = True
FAIL_ON_MISSING_FORM_WIZARD_HANDLER_PLUGINS = True
FAIL_ON_ERRORS_IN_FORM_ELEMENT_PLUGINS = True
FAIL_ON_ERRORS_IN_FORM_HANDLER_PLUGINS = True
FAIL_ON_ERRORS_IN_FORM_WIZARD_HANDLER_PLUGINS = True
