...
from main.fobi.sample_date.forms import SampleDateForm


class SampleDatePlugin(FormFieldPlugin):
    ...
    def get_form_field_instances(self,
        ...
        kwargs = {
            ...
            'widget': forms.widgets.Date(attrs={})
        }

        return [(self.data.name, forms.CharField, kwargs), ]


form_element_plugin_registry.register(SampleDatePlugin)
